    ...
    $.ajax({
        ...
        success: function (byte_str) {
            ...
            for (var output_name in _outputs) {
                ...
                if (output_type === 'IMAGE' || output_type === 'BINARY' || output_type === 'MOTION') {
                    ...
                    if (output_type === 'IMAGE') {
                        ...
                        _normalize_generic_outputs[output_name] = "none";
                    }
            ...
            if (on_load) {
                ...
                template_minimal();
                $("#output_list option:contains('features')").each(function(){
                ...
                selected_an_output_from_list();
                show_generic_output('features', 'BINARY');
            }
        },
        error: function () {
